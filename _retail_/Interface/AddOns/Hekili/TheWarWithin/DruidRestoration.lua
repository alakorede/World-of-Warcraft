...
spec:RegisterTalents( {
    ...
    maim                        = { 82221, 22570 , 1 }, -- Finishing move that causes Physical damage and stuns the target. Damage and duration increased per combo point: 1 point : 2,014 damage, 1 sec 2 points: 4,029 damage, 2 sec 3 points: 6,043 damage, 3 sec 4 points: 8,058 damage, 4 sec 5 points: 10,072 damage, 5 sec
    ...
    rake                        = { 82199, 1822  , 1 }, -- Rake the target for 6,075 Bleed damage and an additional 59,083 Bleed damage over 15 sec. While stealthed, Rake will also stun the target for 4 sec and deal 60% increased damage. Awards 1 combo point.
    rejuvenation                = { 82217, 774   , 1 }, -- Heals the target for 57,377 over 17 sec. You can apply Rejuvenation twice to the same target. Tree of Life: Healing increased by 50% and Mana cost reduced by 30%.
    renewal                     = { 82232, 108238, 1 }, -- Instantly heals you for 20% of maximum health. Usable in all shapeshift forms.
    rip                         = { 82222, 1079  , 1 }, -- Finishing move that causes Bleed damage over time. Lasts longer per combo point. 1 point : 53,648 over 8 sec 2 points: 80,472 over 12 sec 3 points: 107,296 over 16 sec 4 points: 134,120 over 20 sec 5 points: 160,944 over 24 sec
    ...
    starfire                    = { 91040, 197628, 1 }, -- Call down a burst of energy, causing 36,484 Arcane damage to the target, and 12,450 Arcane damage to all other enemies within 5 yards. Deals reduced damage beyond 8 targets.
    ...
    starsurge                   = { 82200, 197626, 1 }, -- Launch a surge of stellar energies at the target, dealing 38,843 Astral damage.
    sunfire                     = { 82208, 93402 , 1 }, -- A quick beam of solar light burns the enemy for 3,210 Nature damage and then an additional 33,794 Nature damage over 18 sec.
    ...
    wild_growth                 = { 82241, 48438 , 1 }, -- Heals up to 5 injured allies within 30 yards of the target for 23,431 over 7 sec. Healing starts high and declines over the duration. Tree of Life: Affects 2 additional targets.
    -- Restoration
    ...
    cenarion_ward               = { 82052, 102351, 1 }, -- Protects a friendly target for 30 sec. Any damage taken will consume the ward and heal the target for 77,751 over 8 sec.
    ...
    cultivation                 = { 82056, 200390, 1 }, -- When Rejuvenation heals a target below 60% health, it applies Cultivation to the target, healing them for 3,237 over 6 sec.
    ...
    efflorescence               = { 82057, 145205, 1 }, -- Grows a healing blossom at the target location, restoring 2,990 health to three injured allies within 10 yards every 1.5 sec for 30 sec. Limit 1.
    embrace_of_the_dream        = { 82070, 392124, 1 }, -- Wild Growth momentarily shifts your mind into the Emerald Dream, instantly healing all allies affected by your Rejuvenation or Regrowth for 6,063.
    ...
    grove_guardians             = { 82043, 102693, 1 }, -- Summons a Treant which will immediately cast Swiftmend on your current target, healing for 17,017. The Treant will cast Nourish on that target or a nearby ally periodically, healing for 5,317. Lasts 15 sec.
    grove_tending               = { 82047, 383192, 1 }, -- Swiftmend heals the target for 23,608 over 9 sec.
    ...
    lifebloom                   = { 82049, 33763 , 1 }, -- Heals the target for 46,698 over 15 sec. When Lifebloom expires or is dispelled, the target is instantly healed for 23,023. May be active on one target at a time.
    ...
    nourish                     = { 82043, 50464 , 1 }, -- Heals a friendly target for 28,618. Receives 300% bonus from Mastery: Harmony.
    ...
    spring_blossoms             = { 82061, 207385, 1 }, -- Each target healed by Efflorescence is healed for an additional 2,079 over 6 sec.
    ...
    tranquility                 = { 82054, 740   , 1 }, -- Heals all allies within 45 yards for 151,434 over 5.9 sec. Each heal heals the target for another 882 over 8 sec, stacking. Healing decreased beyond 5 targets.
    ...
    verdancy                    = { 82060, 392325, 1 }, -- When Lifebloom blooms, up to 3 targets within your Efflorescence are healed for 12,474.
    ...
    dream_surge                 = { 94600, 433831, 1 }, -- Grove Guardians causes your next targeted heal to create 2 Dream Petals near the target, healing up to 3 nearby allies for 15,400. Stacks up to 3 charges.
    durability_of_nature        = { 94605, 429227, 1 }, -- Your Grove Guardians' Nourish and Swiftmend spells also apply a Minor Cenarion Ward that heals the target for 32,806 over 8 sec the next time they take damage.
    ...
    harmony_of_the_grove        = { 94606, 428731, 1 }, -- Each of your Grove Guardians increases your healing done by 6% while active.
    ...
    bursting_growth             = { 94630, 440120, 1 }, -- When Bloodseeker Vines expire or you use Ferocious Bite on their target they explode in thorns, dealing 8,813 physical damage to nearby enemies. Damage reduced above 5 targets. When Symbiotic Blooms expire or you cast Rejuvenation on their target flowers grow around their target, healing them and up to 3 nearby allies for 2,566.
    ...
    thriving_growth             = { 94626, 439528, 1 }, -- Rip and Rake damage has a chance to cause Bloodseeker Vines to grow on the victim, dealing 16,998 Bleed damage over 6 sec. Wild Growth, Regrowth, and Efflorescence healing has a chance to cause Symbiotic Blooms to grow on the target, healing for 15,400 over 6 sec. Multiple instances of these can overlap.
...
spec:RegisterPvpTalents( {
    deep_roots         = 700 , -- (233755) Increases the amount of damage required to cancel your Entangling Roots or Mass Entanglement by 75%.
    disentanglement    = 59  , -- (233673) Efflorescence removes all snare effects from friendly targets when it heals and its Mana cost is reduced by 40%.
    ...
    preserve_nature    = 5387, -- (353114) Tranquility protects you from all harm while it is channeled, and its healing is increased by 20%.
    ...
    thorns             = 697 , -- (305497) Sprout thorns for 12 sec on the friendly target. When victim to melee attacks, thorns deals 15,400 Nature damage back to the attacker. Attackers also have their movement speed reduced by 50% for 4 sec.
