...
spec:RegisterTalents( {
    ...
    cauterizing_shadows        = {  82687, 459990, 1 }, -- When your Shadow Word: Pain expires or is refreshed with less than 5 sec remaining, a nearby ally within 40 yards is healed for 18,685.
    ...
    divine_star                = {  82682, 110744, 1 }, -- Throw a Divine Star forward 27 yds, healing allies in its path for 6,540 and dealing 7,849 Holy damage to enemies. After reaching its destination, the Divine Star returns to you, healing allies and damaging enemies in its path again. Healing reduced beyond 6 targets.
    dominate_mind              = {  82710, 205364, 1 }, -- Controls a mind up to 1 level above yours for 30 sec while still controlling your own mind. Does not work versus Demonic, Mechanical, or Undead beings or players. This spell shares diminishing returns with other disorienting effects.
    essence_devourer           = {  82674, 415479, 1 }, -- Attacks from your Shadowfiend siphon life from enemies, healing a nearby injured ally for 22,422.
    ...
    halo                       = {  82682, 120517, 1 }, -- Creates a ring of Holy energy around you that quickly expands to a 30 yd radius, healing allies for 17,047 and dealing 20,211 Holy damage to enemies. Healing reduced beyond 6 targets.
    holy_nova                  = {  82701, 132157, 1 }, -- An explosion of holy light around you deals up to 13,775 Holy damage to enemies and up to 9,417 healing to allies within 12 yds, reduced if there are more than 5 targets.
    ...
    manipulation               = {  82672, 459985, 2 }, -- You take 1% less damage from enemies affected by your Shadow Word: Pain or Holy Fire.
    ...
    power_word_life            = {  82676, 373481, 1 }, -- A word of holy power that heals the target for 107,440. Only usable if the target is below 35% health.
    prayer_of_mending          = {  82718,  33076, 1 }, -- Places a ward on an ally that heals them for 7,865 the next time they take damage, and then jumps to another ally within 30 yds. Jumps up to 6 times and lasts 30 sec after each jump.
    ...
    renew                      = {  82717,    139, 1 }, -- Fill the target with faith in the light, healing for 24,339 over 15 sec.
    ...
    shadow_word_death          = {  82712,  32379, 1 }, -- A word of dark binding that inflicts 12,033 Shadow damage to your target. If your target is not killed by Shadow Word: Death, you take backlash damage equal to 8% of your maximum health. Damage increased by 150% to targets below 20% health.
    ...
    circle_of_healing          = {  82624, 204883, 1 }, -- Heals the target and 4 injured allies within 30 yards of the target for 12,426.
    cosmic_ripple              = {  82630, 238136, 1 }, -- When Holy Word: Serenity or Holy Word: Sanctify finish their cooldown, you emit a burst of light that heals up to 5 injured targets within 40 yards for 4,970.
    ...
    divine_hymn                = {  82621,  64843, 1 }, -- Heals all party or raid members within 40 yards for 142,008 over 6.6 sec. Each heal increases all targets' healing taken by 4% for 15 sec, stacking. Healing reduced beyond 5 targets.
    ...
    divine_word                = {  82605, 372760, 1 }, -- The effectiveness of your next Holy Word: Serenity, Sanctify, or Chastise is increased by 30% and grants a corresponding Divine Favor for 15 sec. Chastise: Increases your damage by 20% and refunds 15 sec from the cooldown of Holy Word: Chastise. Sanctify: Blesses the target area, healing up to 5 allies for 67,239 over 15 sec. Serenity: Flash Heal, Heal, and Renew heal for 30% more and cost 20% less mana.
    ...
    holy_word_chastise         = {  82639,  88625, 1 }, -- Chastises the target for 34,438 Holy damage and incapacitates them for 4 sec. Cooldown reduced by 4 sec when you cast Smite.
    holy_word_salvation        = {  82610, 265202, 1 }, -- Heals all allies within 40 yards for 13,017, and applies Renew and 2 stacks of Prayer of Mending to each of them. Cooldown reduced by 15 sec when you cast Holy Word: Serenity or Holy Word: Sanctify.
    holy_word_sanctify         = {  82631,  34861, 1 }, -- Releases miraculous light at a target location, healing up to 5 allies within 10 yds for 36,249. Cooldown reduced by 6 sec when you cast Prayer of Healing and by 2 sec when you cast Renew.
    holy_word_serenity         = {  82638,   2050, 1 }, -- Perform a miracle, healing an ally for 107,752. Cooldown reduced by 6 sec when you cast Heal or Flash Heal.
    ...
    lightwell                  = {  82603, 372835, 1 }, -- Creates a Holy Lightwell. Every 1 sec the Lightwell will attempt to heal a nearby party or raid member within 40 yards that is lower than 50% health for 18,685 and apply a Renew to them for 6 sec. Lightwell lasts for 2 min or until it heals 15 times. Cooldown reduced by 3 sec when you cast Holy Word: Serenity or Holy Word: Sanctify.
    ...
    prayer_of_healing          = {  82632,    596, 1 }, -- A powerful prayer that heals the target and the 4 nearest allies within 40 yards for 10,354.
    ...
    -- Oracle
    assured_safety             = {  94691, 440766, 1 }, -- Prayer of Mending casts apply a Power Word: Shield to your target at 25% effectiveness.
    ...
    preventive_measures        = {  94698, 440662, 1 }, -- Increases the healing done by Prayer of Mending by 15%. All damage dealt by Smite, Holy Fire and Holy Nova increased by 15%.
...
spec:RegisterPvpTalents( {
    ...
    mindgames              = 5639, -- (375901) Assault an enemy's mind, dealing 41,103 Shadow damage and briefly reversing their perception of reality. For 7 sec, the next 39,207 damage they deal will heal their target, and the next 39,207 healing they deal will damage their target.
