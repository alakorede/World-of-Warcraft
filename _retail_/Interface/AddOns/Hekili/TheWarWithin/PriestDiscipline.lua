...
spec:RegisterTalents( {
    ...
    entropic_rift              = {  94684, 447444, 1, "voidweaver" }, -- Mind Blast tears open an Entropic Rift that follows the enemy for 8 sec. Enemies caught in its path suffer 6,634 Shadow damage every 0.8 sec while within its reach.
