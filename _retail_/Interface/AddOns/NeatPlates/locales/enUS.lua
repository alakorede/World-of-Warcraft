...
L["Nameplate Update Rate (ms)"] = true
	L["NAMEPLATE_THROTTLE_TIP"] = "Tip: |cffCCCCCCHow often the nameplates are allowed to update, try increasing this if you are having performance issues."
