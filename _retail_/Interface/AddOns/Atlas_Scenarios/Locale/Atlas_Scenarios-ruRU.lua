-- $Id: Atlas_Scenarios-ruRU.lua 51 2018-04-24 09:19:35Z arith $
--[[
...
L["Alliance's final stop"] = "Конечная остановка Альянса"
L["Amber Kearnen"] = "Эмбер Кеарнен"
L["Attackers"] = "Атакующие"
...
L["Defeat Cloudbender Kobo"] = "Победите Сокрушителя облаков Кобо"
L["Defeat Maki Waterblade"] = "Победите Маки Водореза"
...
L["Horde's final stop"] = "Конечная остановка Орды"
L["Jaina"] = "Джайна"
...
L["Sylvanas and Baine"] = "Сильвана и Бейн"
L["Tanks"] = "Танки"
