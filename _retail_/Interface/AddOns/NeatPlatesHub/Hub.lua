...
--]]
 ...
 -- panel.CustomMouseoverColor.tooltipText = L["Color is defined under the 'Reaction' category."]
  ...
  -- Range Indicator
	...
	panel.WidgetEliteIndicatorBoss = CreateQuickCheckbutton(objectName.."WidgetEliteIndicatorBoss", L["Show on Boss Enemies"], AlignmentColumn, panel.WidgetEliteIndicator, 16)
	panel.WidgetArenaIcon = CreateQuickCheckbutton(objectName.."WidgetArenaIcon", L["Show Arena ID"], AlignmentColumn, panel.WidgetEliteIndicatorBoss)
