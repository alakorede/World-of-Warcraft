...
L.confirm_import = "Sollen die derzeit gewählten Optionen importiert werden? Dabei werden die aktuellen Einstellungen überschrieben, wodurch diese verloren gehen können."
