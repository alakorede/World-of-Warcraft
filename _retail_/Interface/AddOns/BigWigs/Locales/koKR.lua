...
--L.confirm_import = "Are you sure you want to import the currently selected options? This will overwrite your current settings and may cause you to lose your current setup."
