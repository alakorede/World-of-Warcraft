...
function OptionsFrame_Create()
    ...
    OptionsFrame.BlockerFrame:SetScript("OnDragStop", function()
    ...
    OptionsFrame.MasterScaleLabel = OptionsFrame_CreateLabel("Master Scale (%):", xPos, yPos)
...
--~             end)
    ...
    OptionsFrame.ShapeColor:SetTooltip("Click to change shape color.") ----, "ANCHOR_TOP")
