...
StubbyConfig = {
	...
	["boots"] = {
		["enchantrix"] = {
			...
			["triggers"] = "		if Stubby.GetConfig(\"Enchantrix\", \"LoadType\") == \"always\" then\n			LoadAddOn(\"Enchantrix\")\n		else\n			Stubby.Print(\"O Enchantrix não está carregado. Digite /enchantrix para mais informações.\")\n		end\n	",
		},
		["informant"] = {
			...
			["triggers"] = "		local loadType = Stubby.GetConfig(\"Informant\", \"LoadType\")\n		if (loadType == \"always\") then\n			LoadAddOn(\"Informant\")\n		else\n			Stubby.Print(\"Informant não está carregado. Digite /informant para mais informações.\"); -- ### _TRANS\n		end\n	",
		},
	},
	["configs"] = {
		["enchantrix"] = {
