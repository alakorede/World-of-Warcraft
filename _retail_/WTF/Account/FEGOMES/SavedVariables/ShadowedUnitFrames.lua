	...
	["profiles"] = {
		["Default"] = {
			...
			["positions"] = {
				...
				["party"] = {
					["top"] = 177.5276132194485,
					["x"] = 625.4891657067274,
					["point"] = "TOPLEFT",
					["relativePoint"] = "BOTTOMLEFT",
					["y"] = 177.5276132194485,
					["bottom"] = 80.24762027663837,
				},
				["maintanktarget"] = {
					["anchorPoint"] = "RT",
					["anchorTo"] = "$parent",
				...
				["raid"] = {
					["top"] = 162.1193811419744,
					["x"] = 381.3148352269491,
					["point"] = "TOPLEFT",
					["bottom"] = 27.07949646503857,
					["relativePoint"] = "BOTTOMLEFT",
					["y"] = 162.1193811419744,
				},
				["partytargettarget"] = {
				...
				["boss"] = {
					...
					["point"] = "TOPLEFT",
					["relativePoint"] = "BOTTOMLEFT",
					["bottom"] = 399.063389517738,
					["top"] = 578.2633073873076,
				},
				["maintank"] = {
					["anchorPoint"] = "C",
				},
			...
			["tags"] = {
				["Specialization"] = {
					["events"] = "",
					["func"] = "function(unit, unitOwner)\nreturn UnitIsPlayer(unit) and GetSpecializationNameForSpecID(GetSpecializationInfoByID(unit))\nend ",
					["category"] = "misc",
				},
			},
			["loadedLayout"] = true,
			...
			["units"] = {
				...
				["target"] = {
					...
					["text"] = {
						{
							["text"] = "[()name][( - )server][( ()afk())][( )status][( )classification]",
							["size"] = 4,
						}, -- [1]
						nil, -- [2]
						{
							["text"] = "[( )smartlevel( )][faction] [race][( )class][( )classification]",
						}, -- [3]
						{
							["text"] = "[perpp]",
						}, -- [4]
